...
export const Page2 = () => {
  return (
    <div className='main'>
  <img  className="nav navbar" src="./images/nav.png" alt="" />
    <img className='img1 navbar' src="./images/1.png" alt="" />
    <img className='img2 navbar' src="./images/line1.png" alt="" />
    <img  className="img3 navbar" src="./images/pace.png" alt="" />
    <img className='img4 navbar' src="./images/getinfo.png" alt="" />
  <div className='section2'>
    <img className='sgirl' src="./images/smileGirl.png" alt="" />
  ...
  <div className='section4'>
    ...
    <img className='img43' src="./images/company2.png" alt="" />
...
<img className='prof1' src="./images/prof1.png" alt="" />
<img className='prof2' src="./images/prof2.png" alt="" />
<img className='prof3' src="./images/prof3.png" alt="" />
